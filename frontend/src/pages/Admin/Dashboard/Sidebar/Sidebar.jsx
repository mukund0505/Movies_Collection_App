...
const Sidebar = () => {
  return (
    <div className="fixed md:relative bg-[#1a1a1a] h-screen md:h-auto w-64 flex-shrink-0">
        ...
        <ul className="space-y-4">
          {[
            ...
            <li key={item.to}>
              <Link
                to={item.to}
                className="block p-2 bg-gradient-to-b from-green-500 to-lime-400 rounded-full text-center"
              >
                {item.label}
              </Link>
            </li>
