...
//           uploadedImagePath = uploadImageResponse.data.image;
//         } else {
//           // The error is returned through the 'error' variable from the mutation
//           if (uploadImageErrorDetails) {
//             console.error("Failed to upload image: ", uploadImageErrorDetails);
//             toast.error("Failed to upload image");
//           } else {
//             console.error("Failed to upload image, no details available");
//             toast.error("Failed to upload image");
//           }
//           return;
//         }
...
const CreateMovie = () => {
  ...
  return (
    <div className="container flex justify-center items-center mt-4 px-4 md:px-0">
