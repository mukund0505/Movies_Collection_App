  ...
  return (
    <div className="p-3">
      <form onSubmit={handleSubmit} className="space-y-3">
        <input
          type="text"
          className="py-3 px-4 border rounded-lg w-full sm:w-3/4 lg:w-1/2 xl:w-1/3 mx-auto"
          placeholder="Write genre name"
          value={value}
          onChange={(e) => setValue(e.target.value)}
        />
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center">
          <button className="bg-teal-500 text-white py-2 px-4 rounded-lg hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-opacity-50 w-full sm:w-auto mb-2 sm:mb-0">
            {buttonText}
          </button>
